...
## Project Overview
NarcotrackBD is a relational database system designed to manage and monitor narcotics-related cases in Bangladesh.  
The system supports multiple law enforcement and regulatory forces, ensures role-based access control, and maintains complete traceability of cases, evidence, and chain of custody.
